    ...
    <div className="relative mx-auto w-full max-w-[420px]">
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-serif text-sm text-[#1A1008] font-medium">
        ...
        <div className="space-y-4 text-left">
          ...
          <div className="space-y-1.5">
            <label className="block text-[11px] text-[#6B5744] font-medium uppercase tracking-wide">
              Your Name
            </label>
          ...
          <div className="space-y-1.5 relative">
            ...
            <div
              className={`absolute top-[100%] left-0 w-full bg-[#FAF7F2] border border-[#D4C9B0] rounded-[3px] mt-1 z-10 overflow-hidden transition-all duration-300 ${
                dropdownOpen
                  ? "opacity-100 max-h-[200px] shadow-md"
...
export default function HomeClient({ serverStatus }: HomeClientProps) {
  ...
  return (
    <div
      className={`japanese-minimalist min-h-screen bg-[#F5F0E8] text-[#1A1008] selection:bg-[#C41E3A]/10 overflow-hidden relative ${loaded ? "loaded" : ""}`}
    >
      <style
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-[#C41E3A] text-lg transition-colors duration-300 hover:text-[#8B1A2A] cursor-default">
              ⛩
            </span>
          ...
          <nav className="flex items-center gap-6">
            <Link
              href="/explore"
              className="text-xs font-medium text-[#1A1008] hover:text-[#C41E3A] transition-colors"
            >
              Explore
            </Link>
            <Link
            ...
            <Link href="/auth/login">
              <Button
                variant="ghost"
                className="border border-[#C41E3A] text-[#C41E3A] hover:bg-[#C41E3A]/5 bg-transparent text-xs rounded-[4px] px-4 py-2 h-auto shadow-none font-medium"
              >
                Log In
              </Button>
            </Link>
          ...
          <div className="text-left space-y-6 flex flex-col items-start justify-center md:max-w-[560px] relative z-20">
            ...
            <div className="space-y-1">
              <h1
                ...
                className="hero-transition-jp text-[52px] font-normal text-[#1A1008] leading-tight tracking-[0.08em]"
              >
                美しいフォームを
              </h1>
              <h1
            ...
            <p className="hero-transition-sub text-[#6B5744] text-[17px] leading-[1.8] max-w-[440px] font-normal">
              A typeform-style form builder crafted with precision. Create, publish, and analyse —
              with the calm focus of Japanese design.
            </p>
            ...
            <div className="hero-transition-buttons flex flex-wrap items-center gap-4 pt-4">
              ...
              <Link href="/explore">
                <Button
                  variant="link"
                  className="text-[#C41E3A] bg-transparent px-5 py-3.5 h-auto font-medium shadow-none text-sm border-none hover:translate-x-[3px] transition-all hover:no-underline hover:underline"
                >
                  View Demo →
                </Button>
              </Link>
            ...
            {[
              {
                ...
                desc: "Drag-and-drop 8 field types. Set validations, themes, and conditional logic in seconds.",
              },
              {
                step: "二",
                title: "Share Instantly",
                desc: "Publish with a click. Share via custom slug URL, QR code, or embed on your site.",
              },
              {
                step: "三",
                title: "Analyze Results",
                desc: "Real-time drop-off funnel charts, completion rates, and one-click CSV export.",
              },
            ].map((s) => (
              <div
                key={s.step}
              ...
              >
                <div className="text-[48px] font-bold text-[#C41E3A] leading-none">{s.step}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-card bg-[#FAF7F2] border border-[#D4C9B0] rounded-[2px] p-8 space-y-4">
              ...
              <p className="text-[13px] text-[#6B5744] leading-[1.7]">
                Design for Hogwarts sorcerers, Night City cyberpunks, or modern tech founders.
                High-fidelity layouts adjust to your styling with one click.
              </p>
            </div>
            ...
            <div className="feature-card bg-[#FAF7F2] border border-[#D4C9B0] rounded-[2px] p-8 space-y-4">
              ...
              <p className="text-[13px] text-[#6B5744] leading-[1.7]">
                Visualize question funnel drop-offs, track partial drafts, and get clean MCQ
                distributions computed directly in database aggregations.
              </p>
            </div>
            ...
            <div className="feature-card bg-[#FAF7F2] border border-[#D4C9B0] rounded-[2px] p-8 space-y-4">
              ...
              <p className="text-[13px] text-[#6B5744] leading-[1.7]">
                Equipped with honeypot fields and sliding-window IP limits to shield creators from
                spam form submissions and database pollution.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 text-[#A89880]">
              <div
                className={`h-2 w-2 rounded-full ${serverStatus === "healthy" ? "bg-[#4A7C59] animate-pulse" : "bg-[#C41E3A]"}`}
              />
              <span>
                tRPC Server Status: <span className="font-mono capitalize">{serverStatus}</span>
              </span>
            </div>
          </div>
        </div>
