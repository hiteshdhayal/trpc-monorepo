        ...
        <CardContent className="p-0 mt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-[#6B5744] text-xs uppercase tracking-wider font-semibold">Full Name</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#6B5744] text-xs uppercase tracking-wider font-semibold">Password (min. 6 chars)</Label>
              <div className="relative">
